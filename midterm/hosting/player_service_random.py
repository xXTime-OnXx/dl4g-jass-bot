...
logger = logging.getLogger('player_service_random')
...
def create_app():
    ...
    what python file to use:
        ...
        export FLASK_APP=player_service_random.py
        export FLASK_ENV=development
        flask run --host=0.0.0.0 --port=8888
    """

    # create and configure the app
    app = PlayerServiceApp('player_service_random')
...
if __name__ == '__main__':
    app = create_app()
    app.run(host='0.0.0.0', port=8888)  # Set the port to 8000
